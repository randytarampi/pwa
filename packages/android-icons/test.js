...
import androidIcons from './index.js'
import { exec } from 'node:child_process'

test('returns all icons in array', function (t) {
  t.plan(2)
  const icons = androidIcons()
...
test('returns icon for size 48 as Number', function (t) {
  t.plan(2)
  const icon = androidIcons({ size: 48 })
...
test('returns icon for size 96', function (t) {
  t.plan(2)
  const icon = androidIcons({ size: 96 })
...
test('returns icon for size xhdpi', function (t) {
  t.plan(2)
  const icon = androidIcons({ size: 'xhdpi' })
  t.ok(icon.name === 'xhdpi.png', 'icon name correct')
  t.ok(icon.width === 96, 'icon width correct')
})
...
test('cli returns all icons as json w/abbreviated flags', function (t) {
  t.plan(3)
  const expected = '[{"name":"mdpi.png","width":48},{"name":"hdpi.png","width":72},{"name":"xhdpi.png","width":96},{"name":"xxhdpi.png","width":144},{"name":"xxxhdpi.png","width":192},{"name":"splash-pwa-hdpi.png","width":192},{"name":"splash-pwa-xhdpi.png","width":256},{"name":"splash-pwa-xxhdpi.png","width":384},{"name":"splash-pwa-xxxhdpi.png","width":512}]\n'
